...
decoded_dir = f'/groups/CaiLab/personal/Lex/raw/2020-08-08-takei/notebook_pyfiles/decoded/Channel_{ch}/Threshold_{JOB_ID}/Pos_0' 
locations_dir = str(dot_locations)
position_dir = str(directory / position_name / f"Threshold_{JOB_ID}") 
barcode_dst = f'/groups/CaiLab/personal/Lex/raw/2020-08-08-takei/notebook_pyfiles/decoded/Channel_{ch}/Threshold_{JOB_ID}/Pos_0/BarcodeKey' 
