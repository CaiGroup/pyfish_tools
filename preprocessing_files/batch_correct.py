...
directory = Path("/groups/CaiLab/personal/Lex/raw/030922_11kgenes/notebook_pyfiles/dapi_aligned/fiducial_aligned")
...
divide=False #bool to even out illumination (if divide is true, then subtract is automatically false)
