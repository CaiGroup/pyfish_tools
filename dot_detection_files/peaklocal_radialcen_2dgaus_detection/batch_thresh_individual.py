from dot_detection_peaklocal_rad_gaus import find_threshold
...
box_size = 5 #bounding box for peak local max
exclude_border = 3 #number of pixels to exclude from border
threshold_min  = 200 #starting minimum threshold 
threshold_max = 1000 #ending maximum threshold
interval = 100 #interval between min and max
HybCycle = JOB_ID #JOB id from slurm task array
channel = 3 #which channel
...
find_threshold(paths_use, box_size=box_size,exclude_border=exclude_border, threshold_min=threshold_min,
