...
- Normalized codeword score to actually 0-1 after ambiguity weight change
"""
    ...
    def radial_decoding(self,locations,num_barcodes = 4, 
        ...
        if look_for_parity == True:
            ...
            for i in range(len(neighbor_list2)):
                ...
                if cycle == 1:
                    codeword_score = codeword_score/((ambiguity_score_final+1)*0.15)
                elif cycle == 2:
                ...
                codeword_score = codeword_score/((2*num_barcodes)/0.15)
