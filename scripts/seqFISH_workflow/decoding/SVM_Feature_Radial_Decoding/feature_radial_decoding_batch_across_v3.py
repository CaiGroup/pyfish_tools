...
first_radius                = 1.0   #search radii
second_radius               = 1.4   #search radii
...
if parity_round == True:
    for diff in range(2):
        ...
        output_dir = f"/groups/CaiLab/personal/{user}/raw/{exp_dir}/pyfish_tools/output/decoded_v3/final_{first_radius}{second_radius}{third_radius}_seed{min_seed}{high_exp_seed}_heg_svm_p{probability_cutoff*100}_diff{diff}_fdr{desired_fdr*100}/Channel_All/Pos_{JOB_ID}"
