...
num_channels    = 2 #number of channels in your image
stack_bkgrd     = None #path to background images
gamma           = 1.0 #gamma enhancement
kern_hpgb       = 7 #kernel size for 2d gaussian blurring
sigma           = 4 #sigma for 2d or 1d gaussian blurring depending on argument combination
...
SignalProcessParallel(files, correction_type = correction_type, stack_bkgrd=stack_bkgrd, num_channels=num_channels, 
